...
class VotingsControllerTest < ActionController::TestCase
  ...
  test "should create voting" do
    assert_difference('Voting.count') do
      post :create, voting: { einzelbewertung: @voting.einzelbewertung, karteikarte_id: @voting.karteikarte_id, user_id: @voting.user_id }
    end
  ...
  test "should update voting" do
    patch :update, id: @voting, voting: { einzelbewertung: @voting.einzelbewertung, karteikarte_id: @voting.karteikarte_id, user_id: @voting.user_id }
    assert_redirected_to voting_path(assigns(:voting))
  end
